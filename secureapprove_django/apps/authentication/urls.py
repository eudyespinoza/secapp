...
urlpatterns = [
    ...
    path('webauthn/rename/', 
         views.webauthn_rename_credential, 
         name='webauthn_rename_credential'),
    path('webauthn/toggle/', 
         views.webauthn_toggle_credential, 
         name='webauthn_toggle_credential'),
